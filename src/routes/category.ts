...
routerCategory.get('/fetch-by-code/:code', Validation(CheckCodeSchema, "params"), Controller.GetCategoryByCodeController);
routerCategory.get('/fetch-by-book-code/:financeBookCode', Validation(CheckFinanceBookCodeSchema, "params"), Controller.GetCategoryByFinanceBookCodeController);
